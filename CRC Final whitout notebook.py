...
class Window:
    def __init__(self, win):
        ...
        frame1 = ttk.Frame(self.notebook, width=400, height=280)
        ...
        self.btn5=ttk.Button(win, text="Delete All", command=lambda:[self.DelAll()])
        self.btn5.place(x=dir+10, y=400)
        
        self.btn6=ttk.Button(win, text="Info.", command=lambda:[self.MoreInf()])
        self.btn6.place(x=dir+80+10, y=400)
        
        self.btn7=ttk.Button(win, text="Guide", command=lambda:[self.Guide()])
        ...
        self.lblinf1 = ttk.Label(win, text="Method :", font=("Time New Roman", 8))
        self.lblinf1.place(x=495, y=475)
        
        self.lblinf2 = ttk.Label(win, text="Matricule :", font=("Time New Roman", 8))
        self.lblinf2.place(x=495, y=500)
        
        self.lblinf3 = ttk.Label(win, text="GiegLan :", font=("Time New Roman", 8))
        self.lblinf3.place(x=495, y=525)
           
        self.lblinf4 = ttk.Label(win, text="Server :", font=("Time New Roman", 8))
        self.lblinf4.place(x=495, y=550)

        self.lblinf5 = ttk.Label(win, text="Susspension", font=("Time New Roman", 8))
        self.lblinf5.place(x=560, y=475)
        
        self.lblinfMT = ttk.Label(win, text="No Data", font=("Time New Roman", 8))
        self.lblinfMT.place(x=560, y=500)
        
        #Internet
        self.lblinfinternet = ttk.Label(win, text="", font=("Time New Roman", 8), width=10, foreground="")
        self.lblinfinternet.place(x=560, y=550)
        ...
        self.lblinf7 = ttk.Label(win, text="", font=("Time New Roman", 8))
        self.lblinf7.place(x=560, y=525)
